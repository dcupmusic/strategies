...
def objective(trial):
    ...
    class_weights[index_of_class_short] *= 0.7
    class_weights[index_of_class_none] *= 0.1
    class_weights[index_of_class_long] *= 1.2
    ...
    if (financial_results['orders'] > 4):
        del X_train_selected_gpu, X_test_selected_gpu, y_train_tensor_gpu, y_test_tensor_gpu, X_train_list,X_test_list,y_train_seq_ar,y_test_seq_ar,y_train_seq,y_test_seq,x_train_ar,x_test_ar,X_train_tensor,X_test_tensor,y_train_tensor,y_test_tensor, model
...
main_indicies = [66, 3, 100, 132, 70, 41, 107, 75, 12, 112, 113, 21, 86, 119, 121, 125, 62, 95]
