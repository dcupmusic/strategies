...
class lstm_short_agg(Strategy):
    def __init__(self):
        super().__init__()
        self.model = BiLSTMClassifierWithAttention(input_dim, hidden_dim, num_layers, 3, dropout_rate)
        model_filename = '/Users/duncanmaclennan/Documents/Jesse/trade/my-bot/strategies/lstm_short_agg/ADA_TOP_trained_model_lstm_index_[0].pth'
        if model_filename:
        ...
        scaler_params_filename = '/Users/duncanmaclennan/Documents/Jesse/trade/my-bot/strategies/lstm_short_agg/ADA_scaler_params_index_[0].joblib'
