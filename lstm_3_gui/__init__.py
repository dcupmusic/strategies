...
class lstm_3_gui(Strategy):
    def __init__(self):
        super().__init__()
        self.model = BiLSTMClassifierWithAttention(input_dim, hidden_dim, num_layers, 3, dropout_rate)
        model_filename = '/Users/duncanmaclennan/Documents/Jesse/trade/my-bot/strategies/lstm_3_gui/SOL_TOP_trained_model_lstm_index_97.pth'
        if model_filename:
        ...
        scaler_params_filename = '/Users/duncanmaclennan/Documents/Jesse/trade/my-bot/strategies/lstm_3_gui/SOL_scaler_params_index_97.joblib'
